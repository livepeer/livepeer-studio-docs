---
title: Livestreaming from Apps
---

<!-- to be replaced by Shih-Yu Web RTMP tutorial -->

Livepeer Studio global-optimized ingest URL is `rtmp://rtmp.livepeer.studio/live/`.
...
Livepeer Studio is currently working on additional recommendations for mobile SDKs.
Fill out a [contact form](https://livepeer.studio/contact) if you have more urgent
needs.
