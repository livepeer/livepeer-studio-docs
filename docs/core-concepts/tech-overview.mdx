...
Traditionally, transcoding takes place on a centralized server. However, Livepeer Studio takes livestreams and video assets and sends them for transcoding on the [Livepeer Network](https://livepeer.org). 
