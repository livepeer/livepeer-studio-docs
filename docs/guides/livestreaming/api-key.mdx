...
You need an API key to make requests of the Livepeer Studio API. You do not need to
...
is the sole secret you will have to use when making requests to the Livepeer Studio
