...
Also, If you created your stream via the Livepeer Studio API, confirm your profile
...
playback URL in the Livepeer Studio [Test Player](https://livepeer.studio/app/test-player). The Test
...
by the Livepeer Studio CDN. This player is configured to only playback the highest
