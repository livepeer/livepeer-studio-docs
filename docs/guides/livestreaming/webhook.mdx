...
| asset.status | This fires when                                                                                           |
| asset.ready | This fires when exisiting asset is ready to be played without any errors.                                                                                           |
| asset.error | This fires when                                                                                           |
| task.spawned                                                                                              |This fires when an upload task has been created.
| task.status|    This fires when                                                                                         |
| task.finished | This fires when           | 
