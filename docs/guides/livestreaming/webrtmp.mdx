---
title: Live stream with WebRTMP
---
In this tutorial, we show you how to use the Livepeer WebRTMP SDK, which allows you to stream into Livepeer using in-browser streaming. 
...
- Visit http://127.0.01:8080/ in your browser to see the app 
  ...
  Now that you have in-browser streaming set up, you only need a player so viewers can tune into your live streams. Check out our docs on how to embed a video player.