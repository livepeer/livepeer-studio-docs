...
This guide provides steps and information about creating a livestream:

- [Understanding the `stream` object](/guides/livestreaming#about-the-`stream`-object)
- [Ways to create a `stream` object](/guides/livestreaming#ways-to-create-a-`stream`-object)
- [Working with example API requests](/guides/livestreaming#create-a-stream-object-with-a-post-request-to-the-API)
- [No-code stream creation](/guides/livestreaming#no-code-stream-creation-with-the-livepeer-studio-dashboard) (optional)
