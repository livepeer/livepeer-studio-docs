...
We will use the [Livepeer.com test player](https://livepeer.com/app/test-player) to debug. You must
...
Load your playback URL in the [Livepeer.com test player](https://livepeer.com/app/test-player). If
...
Does anything playback in the [Livepeer.com test players](https://livepeer.com/app/test-player)?
...
- **Yes:** You are not transcoding your source stream, and only the source
  ...
  <br />
  Or, if the resolution, FPS and/or bitrate of the source stream is very high and if your internet bandwidth
  is low, playback will be slow and choppy. Consider transcoding your livestreams. If no transcoding
  renditions are available for playback, you are not making use of ABR.
