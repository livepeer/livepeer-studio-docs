...
details in the [API reference](/api/multistream-target/overview).
...
##### Request: [`POST /api/multistream/target`](/api/multistream-target/create-target)
...
##### Request: [`GET /api/multistream/target/{id}`](/api/multistream-target/get-target)
...
##### List Request: [`GET /api/multistream/target`](/api/multistream-target/list-targets)
...
##### Request: [`PATCH /api/multistream/target/{id}`](/api/multistream-target/update-target)
...
##### Request: [`DELETE /api/multistream/target/{id}`](/api/multistream-target/delete-target)
...
[Delete `Multistream Target` API](/api/multistream-target/delete-target).
