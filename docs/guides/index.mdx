...
This Quickstart guide includes a step-by-step process to get you started developing an application with the Livepeer Studio API (for `Node.js` apps). With the Livepeer Studio toolkit, you will be able to develop an application that follows our complete livestreaming cycle and best practice guidelines to:

- [Create a livestream](/guides#create-a-livestream)
- [Record a livestream](/guides#record-a-livestream)
- [Playback a livestream](/guides/#list-recorded-sessions) using the [Livepeer Studio API](/references) with `Node.js`
