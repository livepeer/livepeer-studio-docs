...
This is the default setting, and indicates the ability to record and save the live stream for later views is not yet active `"record": false`. You will be able to change this in the following steps.
...
> **Note:** You can also get the `playbackUrl` by from the dashboard of the stream.
