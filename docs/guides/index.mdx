...
The following settings are required to set up your recording.

## Toggle the recording

1. The default of `record` is set to `off` for a newly created stream. You will make the request to toggle the recording to turn the setting on and record our stream:
