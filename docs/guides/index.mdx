...
This Quickstart guide includes a step-by-step process to get you started developing an application with the Livepeer Studio API (for `Node.js` and `Axios` apps). With the Livepeer Studio toolkit, you will be able to develop an application that follows our complete livestreaming cycle and best practice guidelines to:
...
You can choose which [method](/aboutstudio/tech-overview#methods) to use to stream for your implementation (e.g., Inbrowser, Mobile, Zoom, ...)
