...
A table with descriptions and links to sample apps is also accessible in the  [core concepts](/aboutstudio) section.ct. It provides examples of API requests, and No-code stream creation (optional).
...
A table with descriptions and links to sample apps is also accessible in the  [core concepts](/aboutstudio) section.