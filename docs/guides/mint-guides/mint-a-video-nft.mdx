...
This is a good tutorial for someone who is minting video NFTs for the first time.

- How to get started minting a video NFTs

## What you can build 
- Your own Video NFT
- Video NFT app uploader
...
> **Note:** If you are happy with the NFT minted in the page above you can stop here!
