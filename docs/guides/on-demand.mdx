...
- Understanding Livepeer Studio [core concepts](/aboutstudio)
- Experience working with [`Node.js`](https://nodejs.org/en/)
- Experience working with [`Axios`](https://axios-http.com/)
...
- [A Livepeer Account](https://livepeer.studio/login)
...
> **Note:** using the `GET /api/task/$TASK_ID` request provides different information depending on whether the asset is *imported* or *exported* . 
