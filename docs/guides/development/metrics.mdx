...
stream and understand the metrics for  operating a live-streaming or user generated content platform. y

- View health checks of your Livestream 
- Metrics for your Livestream

## What you need to know
- API 

## Technical Preparation 
- [`API key documentation`](/guides/livestreaming/api-key)
- [Check your stream software configuration](https://livepeer.studio/docs/guides/start-live-streaming/debug-live-stream-issues)
...
`GET livepeer.studio/data/stream/{id}/health`
  - id the stream ID is the same one as used in the regular API.
...
The stream ID is the same one used in the standard API.
