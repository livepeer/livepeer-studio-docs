...
| -------------------------------------------------------------------------------------------------------------- | ---------- | ---------- |
| Multistream recordings to other video platforms (YouTube, Twitch)                                                        |    Stream can reach a wider audience        |    Dependent on if the application supports the use of custom RTMP URL         |
