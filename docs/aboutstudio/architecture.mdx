...
Architecture and workflows of the Livepeer Studio features are presented with the Livepeer decentralized transcoding network:

## Options for Streaming

According to devices being used, there are multiple options for streaming workflow, including but not limited to these common methods:
