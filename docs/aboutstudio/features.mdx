---
title: Component Features and Capabilities
---

The following provides descriptions of components and capabilities you can implement to build your livestreaming application with Livepeer Studio Features:

## Livepeer Studio Features

| Feature | Description  | Capabilities   |
| ------------ | ------------ | ------------ |
|  Livestream  | Livestreaming using broadcasting software or WebRTMP  | <li> Multistream</li> <li>Livestream Recording</li> <li>Suspend streams</li>  |
|  On Demand  | **Upload** and **store videos** for on demand access | <li>Export to IPFS or other services</li> <li>Upload video to Livepeer Studio (API or Dashboard)</li> <li>Store assets on decentralized storage</li>  |
|  Mint | Minting `.mp4` video as an NFT   |  <li>Mint `.mp4` video files</li> <li>Use to create custom ERC-721 smart contracts</li> <li>Deploy to mainnet, testnet or layer 2 solutions like  Polygon in you custom smart contract</li> |
