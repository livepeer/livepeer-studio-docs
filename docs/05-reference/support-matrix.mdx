...
The following technical descriptions highlight capabilities of Livepeer Studio
features and components available for building your livestreaming application:
...
| Mint       | Minting `.mp4` video as an NFT                       | <li>Mint `.mp4` video files</li> <li>Use to create custom ERC-721 smart contracts</li> <li>Deploy to mainnet, testnet or layer 2 solutions like Optimism in your custom smart contract</li> |
