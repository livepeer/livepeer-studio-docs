...
- [Livestream](/core-concepts/livestream) - Stream live into Livepeer's decentralized transcoding network
- [On-Demand](/core-concepts/on-demand) - Upload existing video recordings to Livepeer
- [Mint](/core-concepts/mint) - Ability to mint video NFTs

## How Does Livepeer Work

**Explore** our [Technical Overview](/core-concepts/tech-overview) for an indepth look at how Livepeer Studio works and how it is used.
...
- [Livepeer Studio toolkit](/core-concepts/features/)
...
For more indepth information **_See_** [Livepeer Studio Architechture](/core-concepts/architecture).

## Livepeer Studio Sample Apps Library

[Experiment with our sample applications](/core-concepts/sampleapps) and take it to the next level with your own customization.

## Support Matrix

Learn more about [how we support our features](/core-concepts/features).
