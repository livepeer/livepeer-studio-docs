...
description: Listen for video lifecycle events
metaTitle: Listen for webhook - Livepeer Studio
metaDescription: Listen for video lifecycle events
---
...
2. plit each element, using the `=` character as the separator, to get a prefix
   and value pair.
