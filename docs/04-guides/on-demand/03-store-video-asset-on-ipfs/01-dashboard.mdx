...
pagination_next: guides/live/create-a-livestream/dashboard
---
...
the dashboard to replicate an uploaded video asset to additional storage
providers such as IPFS.
