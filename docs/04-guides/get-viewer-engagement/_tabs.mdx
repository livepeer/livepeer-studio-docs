...
To display viewership data, you need to configure your player first. Currently
the viewership data is only registered if you're using the
...
well. If you have any urgent help with this get in touch with our customer
support anyway and we may be able to assist you.
