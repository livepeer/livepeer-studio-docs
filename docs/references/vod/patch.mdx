...
This allows for modifying the metadata of the asset, which can also be customizable for NFTs. Since each marketplace has their own standard for the `metatdata` of the NFT, it is up to you to determine which standard to use and fields to include.
...
-d {
    ...
    "ipfs": {
        "spec": {
            "nftMetadata": {
                "description": "New description of asset",
                "name": "New Name"
            }
        }
    }
