...
```jsx
{
    ...
    "tusEndpoint: "https://origin.livepeer.studio/api/asset/upload/tus?uploadToken=aHR0cHM6Ly9zdG9yYWdlLmdvb2dsZWFwaXMuY29tL2xwLW55Yy12b2QtbW9uc3Rlci9kaXJlY3RVcGxvYWQvNjI3OHQyZWlrY2JqZXUxNC9zb3VyY2U%2F...",
    "asset": {
        "id": "$ASSET_ID",
...
Further examples and documentation can be found on [https://github.com/tus/tus-js-client/blob/master/docs/usage.md](https://github.com/tus/tus-js-client/blob/master/docs/usage.md) 
