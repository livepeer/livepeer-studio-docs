...
```jsx
  ...
  const upload = new tus.Upload(file, {
      ...
      urlStorage: new (tus as any).FileUrlStorage("/tmp/file"),
      metadata: {
        filename,
        filetype: "video/mp4",
      },
...
You can find further examples and documentation on [https://github.com/tus/tus-js-client/blob/master/docs/usage.md](https://github.com/tus/tus-js-client/blob/master/docs/usage.md) 
or clients available in other languages at [https://tus.io/implementations.html](https://tus.io/implementations.html)
