---
title: About Streaming Protocols
--- 


The following provides detailed high-level descriptions about the most commonly used streaming protocols that handle both video and audio data, and how they operate with streaming media (**Note:** *not all are supported by Livepeer at this time*), they include but are not limited to:
...
A protocol is a well-defined method used to send/receive data. The two types of protocols covered in this reference are categorized as:
